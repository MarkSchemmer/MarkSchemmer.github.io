...
import { pieceMap } from "../chess-board/chess-board.component";
...
// Need to implement King logic at WhiteKing Logic
// And for BlackKing
// Finish implementing CanKingMove.
...
export class WhiteKing extends King {
    ...
    public FindMovesAndReturnCells = (cell: ChessCell): ChessCell[] => {
        return this.getKingMovesAndReturnCells(cell);
    }

    public getKingMovesAndReturnCells = (cell: ChessCell) => {
        ...
        let moves  = [
            ...
            return this.chessRules.canKingMove(fromCell, toCell, pieceColor, pieceMap);
        });
    ...
    public getKingMoves = (cell: ChessCell) => {
        ...
        return this.poolOfSquaresThatCanMoveOrAttack;
...
export class ChessPieceFactory {
    ...
    PieceTypeGenerator = (pieceName: PieceName, pieceColor: PieceColor, obj) => {
        switch(pieceName) {
            case PieceName.POND: {
                return pieceColor === PieceColor.WHITE ? Object.assign(new WhitePond(), obj) : Object.assign(new BlackPond(), obj);
            }
            case PieceName.ROOK: {
                return pieceColor === PieceColor.WHITE ? Object.assign(new WhiteRook(), obj) : Object.assign(new BlackRook(), obj);
            }
            case PieceName.BISHOP: {
                return pieceColor === PieceColor.WHITE ? Object.assign(new WhiteBishop(), obj) : Object.assign(new BlackBishop(), obj);
            }
            case PieceName.KNIGHT: {
                return pieceColor === PieceColor.WHITE ? Object.assign(new WhiteKnight(), obj) : Object.assign(new BlackKnight(), obj);
            }
            case PieceName.QUEEN: {
                return pieceColor === PieceColor.WHITE ? Object.assign(new WhiteQueen(), obj) : Object.assign(new BlackQueen(), obj);
            }
            case PieceName.KING: {
                return pieceColor === PieceColor.WHITE ? Object.assign(new WhiteKing(), obj) : Object.assign(new BlackKing(), obj);
            }
            default: {
                // console.log("default.");
                return null;
